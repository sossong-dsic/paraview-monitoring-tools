// Header
#include "DssVtpHighzVolumesClassified.h"
...
/*----------------------------------------------------------------------------*/
class DssVtpHighzVolumesClassified::vtkInternal
{
public:
	vtkInternal()
	{
...
/*----------------------------------------------------------------------------*/
vtkStandardNewMacro(DssVtpHighzVolumesClassified);
vtkInformationKeyMacro(DssVtpHighzVolumesClassified, DESCRIPTIVE_NAME, String);

/*----------------------------------------------------------------------------*/
DssVtpHighzVolumesClassified::DssVtpHighzVolumesClassified() :
  machine_name_("AMT")
...
/*----------------------------------------------------------------------------*/
bool DssVtpHighzVolumesClassified::HasData()
{
	return this->Internal->HasData();
}

/*----------------------------------------------------------------------------*/
void DssVtpHighzVolumesClassified::UpdatePipeline()
{
	if (this->HasData())
	{
		this->Modified();
...
/*----------------------------------------------------------------------------*/
void DssVtpHighzVolumesClassified::ToggleConnection(bool checked)
{
  if(checked) Connect();
  else Disconnect();
}
/*----------------------------------------------------------------------------*/
void DssVtpHighzVolumesClassified::Connect()
{

  KafkaConnectionInfo kafkaConnectionInfo(std::string("dss.vtp.highz.volumes.classified"),
			kafka_broker_name_,
...
void DssVtpHighzVolumesClassified::Disconnect()
{
...
/*----------------------------------------------------------------------------*/
void DssVtpHighzVolumesClassified::ReadKafkaBus()
{
  if(connected_to_kafka_)
  {
    int64_t lowWatermarkOffset=-1;
...
void DssVtpHighzVolumesClassified::ForceReadKafkaBus()
{
...
/*----------------------------------------------------------------------------*/
void DssVtpHighzVolumesClassified::Clear()
{
...
void DssVtpHighzVolumesClassified::UpdatePipelineWithPolyData(vtkPolyData* polyData)
{
	if (polyData != NULL)
	{
...
/*----------------------------------------------------------------------------*/
int DssVtpHighzVolumesClassified::RequestData(
		vtkInformation *request,
		vtkInformationVector **inputVector,
		vtkInformationVector *outputVector)
{
	vtkInformation* outInfo = outputVector->GetInformationObject(0);
	outInfo->Set(DssVtpHighzVolumesClassified::DESCRIPTIVE_NAME(), "DssVtpHighzVolumesClassified");
...
/*----------------------------------------------------------------------------*/
void DssVtpHighzVolumesClassified::PrintSelf(ostream& os, vtkIndent indent)
{
	this->Superclass::PrintSelf(os, indent);
}
/*----------------------------------------------------------------------------*/
void DssVtpHighzVolumesClassified::SetMachineName(int name_enum)
{
  switch (name_enum)
  {
    case 1:
