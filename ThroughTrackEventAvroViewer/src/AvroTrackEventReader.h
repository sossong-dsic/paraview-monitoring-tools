#ifndef __AvroTrackEventReader_h
#define __AvroTrackEventReader_h
...
#include <das-avro-types/ThroughTrackEventPacket.hh>

template < typename AvroMessage >
class AvroTrackEventReader
{
    typedef typename boost::shared_ptr< AvroMessage > AvroMessageSharedPtr;

public:
    AvroTrackEventReader(std::string base_data_dir, bool verbose = false)
    ...
    AvroTrackEventReader(bool verbose = true)
...
#endif /* __AvroTrackEventReader_h */
