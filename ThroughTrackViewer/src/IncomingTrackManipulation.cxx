#include "IncomingTrackManipulation.h"
...
/*----------------------------------------------------------------------------*/
vtkStandardNewMacro(IncomingTrackManipulation);
vtkInformationKeyMacro(IncomingTrackManipulation, DESCRIPTIVE_NAME, String);

/*----------------------------------------------------------------------------*/
IncomingTrackManipulation::IncomingTrackManipulation()
{
	...
	this->XBounds[0] = 0.0;
	this->XBounds[1] = 1000.0;

	this->YBounds[0] = 0.0;
	this->YBounds[1] = 1000.0;

	this->ZBounds[0] = 0.0;
	this->ZBounds[1] = 1000.0;
}
...
void IncomingTrackManipulation::Clear()
{
...
void IncomingTrackManipulation::SetMomentum(double momentum)
{
	this->Momentum = momentum;
}

void IncomingTrackManipulation::SetTrackLength(double length)
{
	this->TrackLength = length;
}

void IncomingTrackManipulation::SetScatteringAngle(double scatteringAngle)
{
	this->ScatteringAngle = scatteringAngle;
}

void IncomingTrackManipulation::SetDOCA(double doca)
{
	this->DOCA = doca;
}

void IncomingTrackManipulation::SetXBounds(double x0, double x1)
{
	this->XBounds[0] = x0;
	this->XBounds[1] = x1;
}

void IncomingTrackManipulation::SetYBounds(double y0, double y1)
{
	this->YBounds[0] = y0;
	this->YBounds[1] = y1;
}

void IncomingTrackManipulation::SetZBounds(double z0, double z1)
{
	this->ZBounds[0] = z0;
	this->ZBounds[1] = z1;
}

bool IncomingTrackManipulation::isPoCAWithinBounds(double x, double y, double z)
{
//	std::cout << "\n" << std::endl;
//	std::cout << "x: " << x <<
//				 " , y: " << y <<
...
/*----------------------------------------------------------------------------*/
int IncomingTrackManipulation::RequestData(
		...
		vtkInformationVector *outputVector)
{
	...
	outInfo0->Set(IncomingTrackManipulation::DESCRIPTIVE_NAME(), "Filtered Particle Trajectory");

	vtkPolyData *output0 = vtkPolyData::SafeDownCast(outInfo0->Get(vtkDataObject::DATA_OBJECT()));

	vtkInformation *outInfo1 = outputVector->GetInformationObject(1);
	outInfo1->Set(IncomingTrackManipulation::DESCRIPTIVE_NAME(), "Filtered PoCA Points");
...
void IncomingTrackManipulation::PrintSelf(ostream& os, vtkIndent indent)
{
